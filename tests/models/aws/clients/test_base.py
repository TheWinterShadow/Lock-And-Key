...
class TestAWS(unittest.TestCase):
    ...
    @patch("lock_and_key.modules.aws.clients.base.Session")
    @patch("lock_and_key.modules.aws.clients.base.json.load")
    @patch("builtins.open", new_callable=mock_open)
    def test_init(self, mock_file, mock_json_load, mock_session_class):
        from lock_and_key.modules.aws.clients.base import AWS
    ...
    @patch(
        "lock_and_key.modules.aws.clients.base.json.load",
