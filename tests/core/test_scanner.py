...
class TestLockAndKeyScanner(unittest.TestCase):
    ...
    @patch("click.confirm")
    @patch("click.prompt")
    def test_run_interactive_single_provider(
        self, mock_prompt, mock_confirm, mock_banner
    ):
        ...
        mock_confirm.side_effect = [
            True,
            False,
        ]  # Proceed with scan, don't scan another
        ...
        mock_provider.run_analysis.assert_called_once_with(
            mock_creds, output_dir="./test_reports"
        )
