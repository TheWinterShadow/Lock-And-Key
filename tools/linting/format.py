...
def main():
    ...
    # Run black
    print("Running black...")
    black_cmd = [sys.executable, "-m", "black", "--line-length", "120"] + [str(f) for f in py_files]
    ...
    # Run isort
    print("Running isort...")
    isort_cmd = [sys.executable, "-m", "isort", "--profile", "black", "--line-length", "120"] + [str(f) for f in py_files]
